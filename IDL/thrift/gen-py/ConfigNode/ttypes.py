...
class ethConfigInfo(object):
    ...
    def __init__(self, ip=None, name=None, database=None,):
        self.ip = ip
        self.name = name
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('ethConfigInfo')
        ...
        if self.database is not None:
            oprot.writeFieldBegin('database', TType.LIST, 3)
            oprot.writeListBegin(TType.STRING, len(self.database))
            for iter48 in self.database:
...
all_structs.append(ethConfigInfo)
ethConfigInfo.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'ip', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'name', 'UTF8', None, ),  # 2
    (3, TType.LIST, 'database', (TType.STRING, 'UTF8', False), None, ),  # 3
)
