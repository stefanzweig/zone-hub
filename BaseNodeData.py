...
# try:
#     exec_intry_path_ = os.path.abspath(os.path.join(os.getcwd(), sys.argv[0]))
#     config_yaml_file = os.path.join(exec_intry_path_, "../etc/zonemaster_config.yaml")
#     with open(config_yaml_file, encoding='utf-8') as f:
#         data = yaml.safe_load(f)
# except Exception as e_ :
#     exec_intry_path_ = os.path.dirname(__file__)
#     config_yaml_file = os.path.join(exec_intry_path_, "../etc/zonemaster_config.yaml")
#     with open(config_yaml_file, encoding='utf-8') as f:
#         data = yaml.safe_load(f)
